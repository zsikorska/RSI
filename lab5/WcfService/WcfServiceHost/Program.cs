...
namespace WcfServiceHost
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ServiceHost myHost = new ServiceHost(typeof(PersonService), baseAddress);
            
            BasicHttpBinding myBinding = new BasicHttpBinding();
            ServiceEndpoint endpoint1 = myHost.AddServiceEndpoint(typeof(IPersonService), myBinding, "endpoint1");

            WSHttpBinding binding2 = new WSHttpBinding();
            binding2.Security.Mode = SecurityMode.None;
            ServiceEndpoint endpoint2 = myHost.AddServiceEndpoint(typeof(IPersonService), binding2, "endpoint2");
